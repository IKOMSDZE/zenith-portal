            ...
            <div className="p-8 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <input type="number" value={editingRecord.closingBalance} onChange={e => setEditingRecord({...editingRecord, closingBalance: parseFloat(e.target.value) || 0})} className="w-full bg-slate-50 border border-slate-200 px-4 py-2.5 rounded-[5px] text-[12px] font-black outline-none focus:border-indigo-500" />
                </div>
              </div>
            </div>
